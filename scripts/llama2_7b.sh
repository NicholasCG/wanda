...
python main.py \
    ...
    --sparsity_ratio 0 \
    --sparsity_type "unstructured" \
    --save "out/llama_7b/seed_$seed/dense/" \
    --seed $seed --eval_zero_shot
echo "Finished no pruning"

# llama-7b with wanda pruning method
echo "Running with wanda pruning method"
run_python_command "wanda" "unstructured" "out/llama_7b/seed_$seed/unstructured/wanda/"
run_python_command "wanda" "2:4" "out/llama_7b/seed_$seed/2-4/wanda/"
run_python_command "wanda" "4:8" "out/llama_7b/seed_$seed/4-8/wanda/"
echo "Finished wanda pruning method"

# llama-7b with sparsegpt pruning method
echo "Running with sparsegpt pruning method"
run_python_command "sparsegpt" "unstructured" "out/llama_7b/seed_$seed/unstructured/sparsegpt/"
run_python_command "sparsegpt" "2:4" "out/llama_7b/seed_$seed/2-4/sparsegpt/"
run_python_command "sparsegpt" "4:8" "out/llama_7b/seed_$seed/4-8/sparsegpt/"
echo "Finished sparsegpt pruning method"

# llama-7b with magnitude pruning method
echo "Running with magnitude pruning method"
run_python_command "magnitude" "unstructured" "out/llama_7b/seed_$seed/unstructured/magnitude/"
run_python_command "magnitude" "2:4" "out/llama_7b/seed_$seed/2-4/magnitude/"
run_python_command "magnitude" "4:8" "out/llama_7b/seed_$seed/4-8/magnitude/"
echo "Finished magnitude pruning method"